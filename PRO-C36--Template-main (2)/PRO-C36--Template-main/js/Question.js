class Question {
  ...
  display(){
    ...
    this.question.html("Question:- What walks on 4 legs in the morning, on 2 legs in the afternoon, and on 3 legs in the evening? " );
    // question.html("Question:- What starts and ends with the letter ‘E’, but has only one letter? " );

    this.question.position(25, 80);
    this.option1.html("1: Homosapien " );
    this.option1.position(150, 100);
    this.option2.html("2: Human Being" );
